    ...
    <LampContainer>
      ...
      >
        <h1 className="font-normal">
          <span className="text-white-custom">Sty</span>
          <span className="text-green-custom">lichess</span>
        </h1>
        <h1>Lichess, but with your style</h1>
      </motion.div>
    </LampContainer>
  );
}
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[40rem] flex-col overflow-hidden rounded-md z-0",
        className
      )}
    >
